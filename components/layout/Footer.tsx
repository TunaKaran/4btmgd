    ...
    <footer className="bg-navy-900 border-t border-slate-800 text-slate-400 font-sans">
          ...
          <div className="space-y-6">
            ...
            <p className="text-sm leading-relaxed text-slate-400">
              ...
              <span className="text-white font-medium">
                yetkilendirilmiş TMGDK
              </span>{" "}
              kuruluşuyuz. Gaziantep ve VII. Bölge Müdürlüğü sahasında,
              tehlikeli madde süreçlerinizi cezai risklerden uzak, mevzuata tam
              uyumlu şekilde yönetiyoruz.
            </p>
            <div className="flex gap-4">
              <a
                href="#"
                className="p-2 bg-slate-800 rounded-full hover:bg-teal-600 hover:text-white transition-all"
              >
      ...
      <div className="border-t border-slate-800 bg-navy-950">
        <div className="container mx-auto px-4 py-6 flex flex-col md:flex-row justify-between items-center gap-4 text-xs">
          <p>
            &copy; 2026 4B TMGD San. ve Tic. Ltd. Şti. Tüm hakları saklıdır.
          </p>
